        ...
        protected Double doInBackground(String... search){
            ...
            try{
                ...
                for(Element barcodes: barcode){
                    ...
                    String[] parts2 = barcodeString.split("(?<=\\/Content\\/ProductImages\\/large\\/)(.*)(?=\\.jpg\\/)");
                    Log.d("split", String.valueOf(parts2));
                    for(String strings: parts2){
                        Log.d("Splitrhsdf", strings);
                    }
                    //String[] parts3 = parts2[0].split("/");
                    //Log.d("split", parts3[0]);
                    //String[] parts4 = parts3[0].split("/");
                    //Log.d("split", parts4[0]);
                    //String[] parts5 = parts4[0].split("/");
                    //Log.d("split", parts5[0]);
                    //String[] parts1 = parts2[0].split(".jpg");
                    //Log.d("split", parts1[0]);
